...
source(paste0(opt$zUMIs_directory,"/counting/runfeatureCountFUN.R"))
source(paste0(opt$zUMIs_directory,"/counting/featureCounts.R"))
source(paste0(opt$zUMIs_directory,"/counting/UMIstuffFUN.R"))
